...
function errors()
{
    ...
    {
        document.getElementById('errorCurrPass').innerHTML = 'Incorrect PPassword';
...
function currPassChange()
{
    ...
    {   
        ...
        {   
            ...
            xhttp.open("POST", "check_a_change_password.php", true);//where to go and how??
                ...
                {   
                   ...
                   if (currpass == this.responseText) 
                    ...
                    else
                    {
                        document.getElementById('currpass').style.backgroundColor = '';
                        errorCurrPass=true;
                        document.getElementById('errorCurrPass').innerHTML = 'Incorrectt Password';
                        document.getElementById('errorCurrPass').style.color = 'red';
                    } 
                }
            };
